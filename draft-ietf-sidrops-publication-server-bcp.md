...
status = "bcp"
name = "Internet-Draft"
value = "draft-ietf-sidrops-publication-server-bcp-07"
...
specific circumstances instances, resource holders might instead choose
to deploy and manage a CA themselves. This latter type of CA is commonly
referred to as a "self-hosted" or "delegated" CA.
